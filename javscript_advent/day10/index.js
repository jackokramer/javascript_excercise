...
const allDots = document.querySelectorAll('.dice div')
//console.log(allDots)

function diceRoll(spin){
    let randNumber = 1+ Math.floor(Math.random() * 6);   
    console.log(randNumber); 

    allDots.forEach(dot => dot.class.remove(...dot.classList))
